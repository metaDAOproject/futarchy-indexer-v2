...
let connectionString = process.env.INDEXER_WRITER_PG_URL;
...
const poolConfig = {
  ...
  min: 3,
  max: process.env.DB_MAX_CONNECTIONS ? Number(process.env.DB_MAX_CONNECTIONS) : 128, // Reduced from 1000 to a more reasonable number
