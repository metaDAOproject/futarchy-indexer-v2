...
import { futarchyClient, futarchyClientV06 } from "../../../connections/v0.6";
...
export const futarchyIndexer = createProgramIndexer({
  ...
  name: "futarchy-v0.6",
  programs: [
    futarchyClient.autocrat,         // current (v0.6.1)
    futarchyClientV06.v0_6_0_futarchy,  // old (v0.6.0) // MAY NEED TO REMOVE THIS
  ],
